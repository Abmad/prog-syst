...
int main(int argc, char * argv[], char * envp[])
{
  ...
  msg_snd.params.nbOutils_1 = (r*(max_nbOutils_1-1))+1;
  msg_snd.params.nbOutils_2 = (r*(max_nbOutils_2-1))+1;
  msg_snd.params.nbOutils_3 = (r*(max_nbOutils_3-1))+1;
  msg_snd.params.nbOutils_4 = (r*(max_nbOutils_4-1))+1;
  msg_snd.msg_type = CHEF_TO_MECANO;
  msg_snd.params.duree = 3;//(r*1500)+500;
...
//Cle pour recuperer la file
  ...
  while(1)
	...
	//sleep(10);
      ...
      if (msgrcv(qid, &msg_rcv, MSGSZ, MECANO_TO_CHEF, 0)< 0) 
    	{
